ExternalProject_Add(
    ...
    UPDATE_COMMAND ""
    PATCH_COMMAND patch -p0 -i ${CMAKE_SOURCE_DIR}/third_party/patches/breakpad_patch.patch
...
set(BREAKPAD_EXCEPTION_HANDLER_LIBRARY ${wxWidgets_INSTALL_DIR}/lib)
set(BREAKPAD_EXCEPTION_HANDLER_INCLUDE_DIR ${BREAKPAD_EXCEPTION_HANDLER_INSTALL_DIR}/include)

file(GLOB BREAKPAD_EXCEPTION_HANDLER_LIBRARIES "${BREAKPAD_EXCEPTION_HANDLER_LIBRARY}/*.so")
