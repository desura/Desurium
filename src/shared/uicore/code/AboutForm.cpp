...
#ifdef WIN32
AboutForm::AboutForm(wxWindow* parent) : gcDialog(parent, wxID_ANY, wxT("About Desura"), wxDefaultPosition, wxSize(295,412), wxDEFAULT_DIALOG_STYLE)
#else
AboutForm::AboutForm(wxWindow* parent) : gcDialog(parent, wxID_ANY, wxT("About Desura"), wxDefaultPosition, wxSize(283,462), wxDEFAULT_DIALOG_STYLE)
#endif
{
